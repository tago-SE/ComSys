public class Strings {
    ...
    public static final String SERVER_ARG_ERR               = "Server: Invalid argument.";
    public static final String SERVER_START_ERR             = "Server: Failed to start.";
    public static final String SERVER_STARTED_ON            = "Server: Started";
    public static final String SERVER_WAITING_FOR_CLIENT    = "Server: Waiting for peer...";
    public static final String SERVER_ACCEPT_ERR            = "Server: Failed to accept peer.";
